...
var DYNAMIC_BASE = 10730688, DYNAMICTOP_PTR = 5487776;
...
function _emscripten_dump_ringbuf() {
 var ind;
 for (ind = RINGBUF_LIM + RINGBUF_POS - 1; ind >= RINGBUF_POS; --ind) {
  if (RINGBUF[ind % RINGBUF_LIM] !== undefined && RINGBUF[ind % RINGBUF_LIM] !== null) {
   Module.printErr("Ring buffer: " + RINGBUF[ind % RINGBUF_LIM]);
  }
 }
 RINGBUF.fill(null);
 RINGBUF_POS = 0;
...
var ___tm_timezone = (stringToUTF8("GMT", 5487680, 4), 5487680);
...
var asmLibraryArg = {
 ...
 "dc": jsCall_viiiiiii,
 "cc": jsCall_viiiiiiii,
 "bc": jsCall_viiiiiiiii,
 "ac": jsCall_viiiiiiiiiii,
 "rb": jsCall_viiiijjii,
 "qb": jsCall_viiiji,
 "pb": jsCall_viij,
 "ob": jsCall_viijii,
 ...
 "gb": jsCall_vijj,
 "fb": jsCall_vijji,
 "eb": jsCall_vijjiiiiii,
 "db": jsCall_vji,
 "th": __Exit,
 "c": ___assert_fail,
 "sh": ___buildEnvironment,
 "rh": ___clock_gettime,
 "n": ___cxa_allocate_exception,
 "qh": ___cxa_pure_virtual,
 "ph": ___cxa_thread_atexit,
 "o": ___cxa_throw,
 "oh": ___cxa_uncaught_exception,
 "fa": ___lock,
 "cb": ___map_file,
 "bb": ___setErrNo,
 "ab": ___syscall10,
 ...
 "K": __exit,
 "h": _abort,
 "$b": _atomic_cmpxchgb_wrapper,
 "_b": _atomic_cmpxchgl_be_wrapper,
 "Zb": _atomic_cmpxchgl_le_wrapper,
 "Yb": _atomic_cmpxchgw_be_wrapper,
 "Xb": _atomic_cmpxchgw_le_wrapper,
 "Hg": _chroot,
 "J": _clock_gettime,
 "Gg": _dlclose,
 "Fg": _dlerror,
 ...
 "Eg": _eglBindAPI,
 "Dg": _eglChooseConfig,
 "Cg": _eglCreateContext,
 "Bg": _eglCreateWindowSurface,
 "Ag": _eglDestroyContext,
 "zg": _eglDestroySurface,
 "yg": _eglGetConfigAttrib,
 "Wa": _eglGetDisplay,
 "xg": _eglGetError,
 "wg": _eglGetProcAddress,
 "vg": _eglInitialize,
 "ug": _eglMakeCurrent,
 "tg": _eglQueryString,
 "sg": _eglSwapBuffers,
 ...
 "X": _emscripten_asm_const_ii,
 "ka": _emscripten_asm_const_iii,
 "Va": _emscripten_asm_const_iiii,
 "Ua": _emscripten_asm_const_iiiii,
 "ng": _emscripten_asm_const_iiiiii,
 "mg": _emscripten_coroutine_create,
 "lg": _emscripten_coroutine_next,
 "kg": _emscripten_exit_fullscreen,
 "jg": _emscripten_exit_pointerlock,
 "ja": _emscripten_get_device_pixel_ratio,
 "I": _emscripten_get_element_css_size,
 "Ta": _emscripten_get_gamepad_status,
 "ig": _emscripten_get_heap_size,
 "hg": _emscripten_get_num_gamepads,
 "gg": _emscripten_glActiveTexture,
 "fg": _emscripten_glAttachShader,
 "eg": _emscripten_glBeginQueryEXT,
 "dg": _emscripten_glBindAttribLocation,
 "cg": _emscripten_glBindBuffer,
 "bg": _emscripten_glBindFramebuffer,
 "ag": _emscripten_glBindRenderbuffer,
 "$f": _emscripten_glBindTexture,
 "_f": _emscripten_glBindVertexArrayOES,
 "Zf": _emscripten_glBlendColor,
 "Yf": _emscripten_glBlendEquation,
 "Xf": _emscripten_glBlendEquationSeparate,
 "Wf": _emscripten_glBlendFunc,
 "Vf": _emscripten_glBlendFuncSeparate,
 "Uf": _emscripten_glBufferData,
 "Tf": _emscripten_glBufferSubData,
 "Sf": _emscripten_glCheckFramebufferStatus,
 "Rf": _emscripten_glClear,
 "Qf": _emscripten_glClearColor,
 "Pf": _emscripten_glClearDepthf,
 "Of": _emscripten_glClearStencil,
 "Nf": _emscripten_glColorMask,
 "Mf": _emscripten_glCompileShader,
 "Lf": _emscripten_glCompressedTexImage2D,
 "Kf": _emscripten_glCompressedTexSubImage2D,
 "Jf": _emscripten_glCopyTexImage2D,
 "If": _emscripten_glCopyTexSubImage2D,
 "Hf": _emscripten_glCreateProgram,
 "Gf": _emscripten_glCreateShader,
 "Ff": _emscripten_glCullFace,
 "Ef": _emscripten_glDeleteBuffers,
 "Df": _emscripten_glDeleteFramebuffers,
 "Cf": _emscripten_glDeleteProgram,
 "Bf": _emscripten_glDeleteQueriesEXT,
 "Af": _emscripten_glDeleteRenderbuffers,
 "zf": _emscripten_glDeleteShader,
 "yf": _emscripten_glDeleteTextures,
 ...
 "mf": _emscripten_glDrawElementsInstancedANGLE,
 "lf": _emscripten_glEnable,
 "kf": _emscripten_glEnableVertexAttribArray,
 "jf": _emscripten_glEndQueryEXT,
 "hf": _emscripten_glFinish,
 "gf": _emscripten_glFlush,
 "ff": _emscripten_glFramebufferRenderbuffer,
 "ef": _emscripten_glFramebufferTexture2D,
 "df": _emscripten_glFrontFace,
 "cf": _emscripten_glGenBuffers,
 "bf": _emscripten_glGenFramebuffers,
 "af": _emscripten_glGenQueriesEXT,
 "$e": _emscripten_glGenRenderbuffers,
 "_e": _emscripten_glGenTextures,
 "Ze": _emscripten_glGenVertexArraysOES,
 "Ye": _emscripten_glGenerateMipmap,
 "Xe": _emscripten_glGetActiveAttrib,
 "We": _emscripten_glGetActiveUniform,
 "Ve": _emscripten_glGetAttachedShaders,
 "Ue": _emscripten_glGetAttribLocation,
 "Te": _emscripten_glGetBooleanv,
 "Se": _emscripten_glGetBufferParameteriv,
 "Re": _emscripten_glGetError,
 "Qe": _emscripten_glGetFloatv,
 ...
 "Le": _emscripten_glGetQueryObjecti64vEXT,
 "Ke": _emscripten_glGetQueryObjectivEXT,
 ...
 "ye": _emscripten_glGetUniformLocation,
 "xe": _emscripten_glGetUniformfv,
 "we": _emscripten_glGetUniformiv,
 "ve": _emscripten_glGetVertexAttribPointerv,
 "ue": _emscripten_glGetVertexAttribfv,
 "te": _emscripten_glGetVertexAttribiv,
 "se": _emscripten_glHint,
 "re": _emscripten_glIsBuffer,
 "qe": _emscripten_glIsEnabled,
 "pe": _emscripten_glIsFramebuffer,
 "oe": _emscripten_glIsProgram,
 "ne": _emscripten_glIsQueryEXT,
 "me": _emscripten_glIsRenderbuffer,
 "le": _emscripten_glIsShader,
 "ke": _emscripten_glIsTexture,
 "je": _emscripten_glIsVertexArrayOES,
 "ie": _emscripten_glLineWidth,
 "he": _emscripten_glLinkProgram,
 "ge": _emscripten_glPixelStorei,
 "fe": _emscripten_glPolygonOffset,
 "ee": _emscripten_glQueryCounterEXT,
 ...
 "Cd": _emscripten_glUniform3i,
 "Bd": _emscripten_glUniform3iv,
 "Ad": _emscripten_glUniform4f,
 "zd": _emscripten_glUniform4fv,
 "yd": _emscripten_glUniform4i,
 "xd": _emscripten_glUniform4iv,
 "wd": _emscripten_glUniformMatrix2fv,
 "vd": _emscripten_glUniformMatrix3fv,
 "ud": _emscripten_glUniformMatrix4fv,
 "td": _emscripten_glUseProgram,
 "sd": _emscripten_glValidateProgram,
 "rd": _emscripten_glVertexAttrib1f,
 "qd": _emscripten_glVertexAttrib1fv,
 "pd": _emscripten_glVertexAttrib2f,
 "od": _emscripten_glVertexAttrib2fv,
 "nd": _emscripten_glVertexAttrib3f,
 "md": _emscripten_glVertexAttrib3fv,
 "ld": _emscripten_glVertexAttrib4f,
 "kd": _emscripten_glVertexAttrib4fv,
 "jd": _emscripten_glVertexAttribDivisorANGLE,
 "id": _emscripten_glVertexAttribPointer,
 "hd": _emscripten_glViewport,
 "gd": _emscripten_memcpy_big,
 "fd": _emscripten_request_fullscreen_strategy,
 "Sa": _emscripten_request_pointerlock,
 "ed": _emscripten_resize_heap,
 "Ra": _emscripten_sample_gamepad_data,
 "Qa": _emscripten_set_blur_callback_on_thread,
 "W": _emscripten_set_canvas_element_size,
 "ia": _emscripten_set_element_css_size,
 ...
 "Na": _emscripten_set_keydown_callback_on_thread,
 "Ma": _emscripten_set_keypress_callback_on_thread,
 "La": _emscripten_set_keyup_callback_on_thread,
 "dd": _emscripten_set_main_loop,
 "Ka": _emscripten_set_mousedown_callback_on_thread,
 "Ja": _emscripten_set_mouseenter_callback_on_thread,
 "Ia": _emscripten_set_mouseleave_callback_on_thread,
 "Ha": _emscripten_set_mousemove_callback_on_thread,
 "Ga": _emscripten_set_mouseup_callback_on_thread,
 "Fa": _emscripten_set_pointerlockchange_callback_on_thread,
 "Ea": _emscripten_set_resize_callback_on_thread,
 "Da": _emscripten_set_touchcancel_callback_on_thread,
 ...
 "za": _emscripten_set_visibilitychange_callback_on_thread,
 "ya": _emscripten_set_wheel_callback_on_thread,
 "cd": _emscripten_yield,
 "V": _execv,
 "xa": _execvp,
 "i": _exit,
 "N": _fork,
 ...
 "va": _mktime,
 "ha": _nanosleep,
 "ua": _pthread_cond_destroy,
 "Uc": _pthread_cond_init,
 "ta": _pthread_cond_signal,
 "ga": _pthread_cond_wait,
 "sa": _pthread_condattr_destroy,
 "Tc": _pthread_condattr_init,
 "Sc": _pthread_condattr_setclock,
 "Rc": _pthread_detach,
 "ra": _pthread_equal,
 "qa": _raise,
 "Qc": _setenv,
 ...
 "Nc": _system,
 "Y": _time,
 "Wb": _trace_guest_mem_before_exec_proxy_wrapper,
 "Mc": _usleep,
 "Q": _waitpid,
 "Lc": abortOnCannotGrowMemory,
 "a": DYNAMICTOP_PTR,
 "b": ___dso_handle
};
...
var _BinaryenSizeofAllocateAndWriteResult = Module["_BinaryenSizeofAllocateAndWriteResult"] = function() {
